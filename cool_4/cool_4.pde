...
void setup() {
  ...
  PImage friends = loadImage("narutocool.jpeg");  // 2. Change this to match the name of your photo. 
  size(friends.width, friends.height);
  // 3. Set your friends as the background. 
  background(friends);  // 4. Find an image of a mustache, and drop it onto this sketch. 
...
void draw() {
  ...
  if (mousePressed)
  { 
    image(mustache, mouseX-25, mouseY-10);
  }
